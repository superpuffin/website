    ...
    <div className="min-h-screen flex flex-col justify-between">
      <header className="">
        ...
        {/* <svg version="1.1" viewBox="0 0 1440 100" xmlns="http://www.w3.org/2000/svg">
          <path fill="rgba(0, 167, 225, 1)" d="m0-7.2486e-4v55.785l80-10.699c80-10.3 240-32.302 400-26.602 160 5.3 320 37.302 480 42.602 160 5.7 320-16.302 400-26.602l80-10.699v-23.785z" />
        </svg> */}
      </header>
